...
const LoanForm = (props) => {
    ...
    return (
        <div >
            <form className="animate__animated animate__fadeIn  my-5" onSubmit={handleSubmit(onSubmit)}>
                <div className="container w-50 mx-auto">
                    <div className="text-left card shadow">
                        ...
                        <div className="form-group">
                                ...
                                <select className="form-control shadow-sm" ref={register}  name="loan_type" >
                            ...
                            <div className="row">
                                ...
                                <div className="col">
                                    <div className=" form-group">
                                        ...
                                        <select className="form-control shadow-sm" ref={register}  name="tenure" >
                                            <option>1</option>
                                            <option>2</option>
                                            <option>3</option>
                                            <option>4</option>
